...
const SECTIONS = [
  {
    ...
    title: 'Overview',
    content: [
      'This Cookie Policy explains how NOXR Studio uses cookies and similar technologies on noxr.pk.',
  ...
  },
  {
    ...
    content: [
      ...
      'They help websites recognise your device and remember certain information about your visit.',
      'Cookies improve functionality, performance, and user experience.',
    ],
  },
  {
    id: 'types',
    ...
    content: [
      ...
      'Performance Cookies: Help us understand how visitors interact with our website through anonymised data.',
      'Functionality Cookies: Remember your preferences such as region or previously viewed products.',
      'Marketing Cookies: Used to deliver relevant advertisements and measure campaign effectiveness, if applicable.',
    ],
  },
  {
    id: 'how-we-use',
    ...
    content: [
      'To enable secure checkout and maintain your shopping cart session.',
      'To analyse traffic patterns and improve site performance.',
      'To remember your preferences and enhance browsing experience.',
      'To support marketing campaigns and measure their effectiveness.',
    ],
  },
  {
    id: 'third-party',
    ...
    content: [
      'Some cookies may be set by trusted third-party services such as payment processors or analytics providers.',
  ...
  },
  {
    ...
    content: [
      ...
      'Disabling essential cookies may affect site functionality and checkout process.',
    ],
  },
  {
    id: 'updates',
  ...
  },
  {
    ...
    title: 'Contact',
    content: [
      'For questions regarding this Cookie Policy, contact hello@noxr.pk.',
